...
\thesistitle{Case 2: Kompromitterte brukerkontoer}
\thesisshorttitle{Case 2: Kompromitterte brukerkontoer}
...
%\input{0_forord}
\input{case_2/1_introduksjon.tex}
\input{case_2/2_problemforstaelse.tex}
\input{case_2/3_idemyldring.tex}
\input{case_2/4_datainnsamling.tex}
%\input{case_2/5_dataanalyse.tex}
%\input{case_2/6_rotarsaksidentifisering.tex}
%\input{case_2/7_problemeliminering.tex}
%\input{case_2/8_losningsimplementering.tex}
%\input{case_2/9_diskogkonk.tex}
%\input{case_2/vedlegg.tex}
