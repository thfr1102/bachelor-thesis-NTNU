...
\input{2_problemforstaelse.tex}
\input{3_idemyldring.tex}
\input{4_datainnsamling.tex}
%\input{case_1/5_dataanalyse.tex}
%\input{case_1/6_rotarsaksidentifisering.tex}
%\input{case_1/7_problemeliminering.tex}
%\input{case_1/8_losningsimplementering.tex}
%\input{case_1/9_diskogkonk.tex}
%\input{case_1/vedlegg}
