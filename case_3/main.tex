...
\thesistitle{Case 3: XXX}
\thesisshorttitle{Case 3: XXX}
...
%\input{0_forord}
\input{case_3/1_introduksjon}
\input{case_3/2_problemforstaelse.tex}
\input{case_3/3_idemyldring.tex}
\input{case_3/4_datainnsamling.tex}
\input{case_3/5_dataanalyse.tex}
\input{case_3/6_rotarsaksidentifisering.tex}
\input{case_3/7_problemeliminering.tex}
\input{case_3/8_losningsimplementering.tex}
\input{case_3/9_diskogkonk.tex}
\input{case_3/vedlegg.tex}
