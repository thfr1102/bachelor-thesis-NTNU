...
\end{figure}
 ...
 \begin{figure}[H]
    ...
    \caption[Endre IT-reglementet]{}
    \label{fig:IT-reglement}
\end{figure}

Fra dataanalysen kom fram til at selv om det finnes tekniske løsninger, har ikke SOCen hatt mulighet til å implementere DNS blokkering på bakgrunn av mangel på ressurser. Figur \ref{fig:Blokkering} og \ref{fig:Øke-antall} viser hva som skal til for å blokkere DNS og hva som må til for å øke ressursene til SOCen.    
 \begin{figure}[H]
    \centering
...
\end{figure}
 ...
 \begin{figure}[H]
    ...
    \caption[Øke antall ansette i SOC]{}
    \label{fig:Øke-antall}
\end{figure}

På hver av disse figurene har vi brukt estimater på hvor stor virkning forskjellige tiltak vil ha, og hva slags krefter for og imot tiltaket vil møte. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Diskusjon}