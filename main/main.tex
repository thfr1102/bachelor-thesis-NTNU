...
\input{main/forsider.tex} % this is the file which contains all the details about your thesis

\makefrontpages % make the frontpages

\input{main/1_Introduksjon/0_forord.tex}
...
\input{main/1_Introduksjon/1_begreper.tex}
%\input{main/1_Introduksjon/2_kortfattet_sammendrag.tex}
\input{main/1_Introduksjon/3_bakgrunn.tex}
\input{main/1_Introduksjon/4_problemstilling.tex}
\input{main/1_Introduksjon/5_motivasjon.tex}
\input{main/1_Introduksjon/6_rammer.tex}
\input{main/1_Introduksjon/7_avgrensning.tex}
\input{main/1_Introduksjon/8_prosjektmaal.tex}
\input{main/1_Introduksjon/9_organisering.tex}
\input{main/2_Casebeskrivelser/1_torrents.tex}
\input{main/2_Casebeskrivelser/2_kontoer.tex}
\input{main/2_Casebeskrivelser/3_kryptovaluta.tex}
\input{main/3_Teori/1_rotaarsaksanalyse.tex}
\input{main/4_Metode/1_metodevalg.tex}
\input{main/4_Metode/2_metode.tex}
\input{main/4_Metode/3_gjennomforelse.tex}
\input{main/5_Resultater/2_case1_resultater.tex}
\input{main/5_Resultater/3_case2_resultater.tex}
\input{main/5_Resultater/4_case3_resultater.tex}
\input{main/6_Diskusjon/1_diskusjon.tex}
\input{main/9_retningslinjer/veiledning_vedlegg.tex}
\input{main/7_Konklusjon/1_konklusjon.tex}
...
\input{main/8_Vedlegg/1_sporreundersokelser.tex}
\input{main/8_Vedlegg/2_plakat.tex}
\input{main/8_Vedlegg/3_frekvenstabeller_case1.tex}
\input{main/8_Vedlegg/4_diverse_histogrammer.tex}
\input{main/8_Vedlegg/5_statistisk_analyse_case2.tex}
\input{main/8_Vedlegg/6_flytdiagrammer.tex}
\input{main/8_Vedlegg/7_motereferater.tex}
\input{main/8_Vedlegg/8_transkripsjon.tex}
